...
export function defaultSave(): SaveData {
  ...
  return { inventory: inv, equipped, equippedShield: DEFAULT_SHIELD_ID, bestStage: 0, gold: 0, purchased: [], locked: [], bestFloor: 0, playerLevel: 1, playerExp: 0, stageStars: {}, gems: {} };
}
...
export function loadSave(): SaveData {
  try {
    ...
    const save: SaveData = {
      ...
      playerLevel: typeof parsed.playerLevel === "number" && parsed.playerLevel >= 1 ? parsed.playerLevel : 1,
      playerExp: typeof parsed.playerExp === "number" && parsed.playerExp >= 0 ? parsed.playerExp : 0,
      stageStars: parsed.stageStars && typeof parsed.stageStars === "object" ? parsed.stageStars : {},
      gems: parsed.gems && typeof parsed.gems === "object" ? parsed.gems : {},
    };
    fixEquipped(save);
    return save;
  } catch {
